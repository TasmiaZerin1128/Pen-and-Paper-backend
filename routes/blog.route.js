...
router
    .route('/:blogId')
    .put(authMiddleware.authenticate, blogMiddleware, blogController.editBlogByBlogId);
router
    .route('/:blogId')
    .delete(authMiddleware.authenticate, blogMiddleware, blogController.deleteBlogByBlogId);
